...
#/content/drive/MyDrive/Pedestrian/datasets/
data_root_crowdhuman = '/content/drive/MyDrive/Pedestrian/datasets/CrowdHuman/'
...
train_pipeline = [
    ...
    #ours [(1600, 400), (1600, 1400)] [(2048, 800), (2048, 1024)]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=(data_root_crowdhuman + 'train.json',data_root_wider + "ad_train.json", data_root_wider + "sur_train.json"),
    ...
    val=dict(
        type=dataset_type,
        ann_file=(data_root_crowdhuman + 'val.json', data_root_wider + "val.json"),
